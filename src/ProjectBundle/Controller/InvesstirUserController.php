...
class InvesstirUserController extends Controller
{
...
$m=$projet->getMontant()+$montant;
            ...
            return $this->redirectToRoute('projet_show_visiteur_projet_user', array('idProjet' => $projet->getIdprojet()));
        }


        return $this->render('projetuser/affichevisiteurProjet.html.twig', array(
            'projet' => $projet,
    ...
    public function affichInvestissementAction(){
        ...
        return $this->render('projetuser/filtre.html.twig',array('list'=>$list));
    }
