...
class ProjetuserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('projetuser/index.html.twig', array(
            'projets' => $projets,
            'proj' => $projets
        ));
    }
    ...
    public function indexallAction()
    {
        ...
        return $this->render('projetuser/indexAll.html.twig', array(
            'projets' => $projets,
            'iduser'=> $id,
            'top'=>$topp,
            'topaimer'=>$topaimer
    ...
    {$user=$this->getUser();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('projet_show_user', array('idProjet' => $projet->getIdprojet()));
        }

        return $this->render('projetuser/new.html.twig', array(
            'projet' => $projet,
    ...
    public function showAction(Projet $projet,Request $request)
    {
        ...
        return $this->render('projetuser/show.html.twig', array(
            'projet' => $projet,
    ...
    public function editAction(Request $request, Projet $projet)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('projet_edit_user', array('idProjet' => $projet->getIdprojet()));
        }

        return $this->render('projetuser/edit.html.twig', array(
            'projet' => $projet,
    ...
    private function createDeleteForm(Projet $projet)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('projet_delete_user', array('idProjet' => $projet->getIdprojet())))
            ->setMethod('DELETE')
            ->getForm();
