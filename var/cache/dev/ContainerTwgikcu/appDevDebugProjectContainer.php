...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('N0G0UgffCc', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getTwigService()
    {
        ...
        $f->setDisplayOptions(['maxStringLength' => 4096, 'fileLinkFormat' => $b]);
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CQHTVIde+9', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gvVQyg66FJ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3XnATyp-TN', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(['defaultPaginationTemplate' => '@KnpPaginator/Pagination/twitter_bootstrap_v3_pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => '@KnpPaginator/Pagination/filtration.html.twig', 'defaultPageRange' => 5]);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\UserBundle/Resources/views'), '!User');
        $instance->addPath(($this->targetDirs[3].'\\src\\Reclamation1Bundle/Resources/views'), 'Reclamation1');
        $instance->addPath(($this->targetDirs[3].'\\src\\Reclamation1Bundle/Resources/views'), '!Reclamation1');
        $instance->addPath(($this->targetDirs[3].'\\src\\ProjectBundle/Resources/views'), 'Project');
        $instance->addPath(($this->targetDirs[3].'\\src\\ProjectBundle/Resources/views'), '!Project');
        $instance->addPath(($this->targetDirs[3].'\\src\\FormationBundle/Resources/views'), 'Formation');
        $instance->addPath(($this->targetDirs[3].'\\src\\FormationBundle/Resources/views'), '!Formation');
        $instance->addPath(($this->targetDirs[3].'\\src\\InterviewsBundle/Resources/views'), 'Interviews');
        $instance->addPath(($this->targetDirs[3].'\\src\\InterviewsBundle/Resources/views'), '!Interviews');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'Reclamation1Bundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Reclamation1Bundle'),
                    'namespace' => 'Reclamation1Bundle',
                ],
                ...
                'ProjectBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ProjectBundle'),
                    'namespace' => 'ProjectBundle',
                ],
                'FormationBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\FormationBundle'),
                    'namespace' => 'FormationBundle',
                ],
                'InterviewsBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\InterviewsBundle'),
                    'namespace' => 'InterviewsBundle',
                ],
                'ForumBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'Reclamation1Bundle' => 'Reclamation1Bundle\\Reclamation1Bundle',
                'CMENGoogleChartsBundle' => 'CMEN\\GoogleChartsBundle\\CMENGoogleChartsBundle',
                'ProjectBundle' => 'ProjectBundle\\ProjectBundle',
                'FormationBundle' => 'FormationBundle\\FormationBundle',
                'InterviewsBundle' => 'InterviewsBundle\\InterviewsBundle',
            ...
            'fos_user.model.user.class' => 'UserBundle\\Entity\\Users',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'badiaa.bouhdid@esprit.tn' => 'badi3a',
            ],
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'UserBundle\\Form\\UsersType',
