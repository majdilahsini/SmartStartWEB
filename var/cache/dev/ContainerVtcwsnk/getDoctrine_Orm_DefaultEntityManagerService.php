...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\OffreBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Reclamation1Bundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ProjectBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\FormationBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\InterviewsBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\ForumBundle\\Entity')]);
...
$b->addDriver($c, 'ProjectBundle\\Entity');
$b->addDriver($c, 'FormationBundle\\Entity');
$b->addDriver($c, 'InterviewsBundle\\Entity');
...
$a->setEntityNamespaces(['OffreBundle' => 'OffreBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'Reclamation1Bundle' => 'Reclamation1Bundle\\Entity', 'ProjectBundle' => 'ProjectBundle\\Entity', 'FormationBundle' => 'FormationBundle\\Entity', 'InterviewsBundle' => 'InterviewsBundle\\Entity', 'ForumBundle' => 'ForumBundle\\Entity']);
