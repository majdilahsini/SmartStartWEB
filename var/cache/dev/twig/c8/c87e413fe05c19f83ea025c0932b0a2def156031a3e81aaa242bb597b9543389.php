...
class __TwigTemplate_47e6179d0932bf942a0e8c2353aaa8b0b1deee23dcc241aee8b3eb3a835ee483 extends \Twig\Template
{
...
($context["role"] ?? $this->getContext($context, "role")) == 0)) ? ("@User/Default/userhome.html.twig") : ("@User/Default/entreprisehome.html.twig")), "@User/Default/modifierprofil.html.twig", 3);
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 51
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "fullname", []), 'label', ["label_attr" => ["class" => "label-smartstart"], "label" => "Fullname"]);
        echo "</td>
                                    <td style=\"width: 425.2px; height: 22px;\">";
        // line 52
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "fullname", []), 'widget', ["attr" => ["class" => "input-smartstart"]]);
        echo "</td>
                                </tr>
                                <tr>
                                    <td style=\"width: 300px; height: 22px;\">";
        // line 55
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "adresse", []), 'label', ["label_attr" => ["class" => "label-smartstart"], "label" => "Adresse"]);
        echo "</td>
                                    <td style=\"width: 425.2px; height: 22px;\">";
        // line 56
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "adresse", []), 'widget', ["attr" => ["class" => "input-smartstart"]]);
        echo "</td>
                                </tr>
                                <tr style=\"height: 22px;\">
                                    <td style=\"width: 300px; height: 22px;\">";
        // line 59
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "tel", []), 'label', ["label_attr" => ["class" => "label-smartstart"], "label" => "Tel"]);
        echo "</td>
                                    <td style=\"width: 425.2px; height: 22px;\">";
        // line 60
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "tel", []), 'widget', ["attr" => ["class" => "input-smartstart"]]);
        echo "</td>
                                </tr>
        ...
        if ((($context["role"] ?? $this->getContext($context, "role")) == 0)) {
            ...
            echo "                        <div style=\"margin-top: 100px\">
                        ...
                        ";
            // line 75
            echo             $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["form2"] ?? $this->getContext($context, "form2")), 'form_start', ["atr" => ["class" => "serach-form-area"]]);
            echo "
                        <table style=\"width: 450px; border-collapse:separate; border-spacing: 0 15px\">
                            <tbody>
                            <tr style=\"height: 22px; \">
                                <td style=\"width: 300px; height: 22px;\">";
            // line 79
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form2"] ?? $this->getContext($context, "form2")), "skill1", []), 'label', ["label_attr" => ["class" => "label-smartstart"], "label" => "Compétence 1"]);
            echo "</td>
                                <td style=\"width: 425.2px; height: 22px;\">";
            // line 80
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form2"] ?? $this->getContext($context, "form2")), "skill1", []), 'widget', ["attr" => ["class" => "combobox-smartstart"]]);
            echo "</td>
                            </tr>
                            <tr>
                                <td style=\"width: 300px; height: 22px;\">";
            // line 83
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form2"] ?? $this->getContext($context, "form2")), "skill2", []), 'label', ["label_attr" => ["class" => "label-smartstart"], "label" => "Compétence 2"]);
            echo "</td>
                                <td style=\"width: 425.2px; height: 22px;\">";
            // line 84
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form2"] ?? $this->getContext($context, "form2")), "skill2", []), 'widget', ["attr" => ["class" => "combobox-smartstart"]]);
            echo "</td>
                            </tr>
                            <tr style=\"height: 22px;\">
                                <td style=\"width: 300px; height: 22px;\">";
            // line 87
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form2"] ?? $this->getContext($context, "form2")), "skill3", []), 'label', ["label_attr" => ["class" => "label-smartstart"], "label" => "Compétence 3"]);
            echo "</td>
                                <td style=\"width: 425.2px; height: 22px;\">";
            // line 88
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form2"] ?? $this->getContext($context, "form2")), "skill3", []), 'widget', ["attr" => ["class" => "combobox-smartstart"]]);
            echo "</td>
                            </tr>
                            <tr style=\"height: 22.6px;\">
            ...
            echo "
                            ...
                            <div style=\"margin-top: 100px\">
                                ...
                                ";
            // line 102
            echo             $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["form3"] ?? $this->getContext($context, "form3")), 'form_start', ["atr" => ["class" => "serach-form-area"]]);
            echo "
                                <table style=\"width: 450px; border-collapse:separate; border-spacing: 0 15px\">
                                    <tbody>
                                    <tr style=\"height: 22px; \">
                                        <td style=\"width: 300px; height: 22px;\">";
            // line 106
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form3"] ?? $this->getContext($context, "form3")), "langue1Ref", []), 'label', ["label_attr" => ["class" => "label-smartstart"], "label" => "Langue 1"]);
            echo "</td>
                                        <td style=\"width: 425.2px; height: 22px;\">";
            // line 107
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form3"] ?? $this->getContext($context, "form3")), "langue1Ref", []), 'widget', ["attr" => ["class" => "combobox-smartstart"]]);
            echo "</td>
                                    </tr>
                                    <tr>
                                        <td style=\"width: 300px; height: 22px;\">";
            // line 110
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form3"] ?? $this->getContext($context, "form3")), "langue2Ref", []), 'label', ["label_attr" => ["class" => "label-smartstart"], "label" => "Langue 2"]);
            echo "</td>
                                        <td style=\"width: 425.2px; height: 22px;\">";
            // line 111
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form3"] ?? $this->getContext($context, "form3")), "langue2Ref", []), 'widget', ["attr" => ["class" => "combobox-smartstart"]]);
            echo "</td>
                                    </tr>
                                     <tr style=\"height: 22.6px;\">
                                        <td colspan=\"2\" align=\"right\" style=\"width: 425.2px; height: 22.6px; padding-top: 50px;\">  <input class=\"submit-smartstart\" type=\"submit\" value=\"Confirmer\" ></td>
                                ...
                                ";
            // line 120
            echo             $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["form3"] ?? $this->getContext($context, "form3")), 'form_end');
            echo "
                            </div>
                        ";
        }
    ...
    <section class=\"profile-detail\" >
        ...
        {% endblock %}", "@User/Default/modifierprofil.html.twig", "C:\\wamp64\\www\\pidev\\src\\UserBundle\\Resources\\views\\Default\\modifierprofil.html.twig");
    }
}
