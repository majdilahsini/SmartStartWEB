...
class __TwigTemplate_b27453802db333a719eceafa445fb1df22c97d40e6083b72d1147a1e7fe7e8f7 extends \Twig\Template
{
...
<section class=\"jobs\">
    <div class=\"container\">
        ...
        if (twig_test_empty((isset($context["offres"]) ? $context["offres"] : $this->getContext($context, "offres")))) {
            // line 29
            echo "                ";
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", []), "pathinfo", []) == "/offre/mesoffres")) {
                // line 30
...
", "@Offre/Entreprise/read.html.twig", "C:\\wamp64\\www\\pidev2\\src\\OffreBundle\\Resources\\views\\Entreprise\\read.html.twig");
    }
}
