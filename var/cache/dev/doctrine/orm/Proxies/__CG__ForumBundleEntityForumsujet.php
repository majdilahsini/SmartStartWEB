 ...
 */
class Forumsujet extends \ForumBundle\Entity\Forumsujet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ForumBundle\\Entity\\Forumsujet' . "\0" . 'idSujet', '' . "\0" . 'ForumBundle\\Entity\\Forumsujet' . "\0" . 'sujet', '' . "\0" . 'ForumBundle\\Entity\\Forumsujet' . "\0" . 'idUser'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Forumsujet $proxy) {
