...
$c = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver([($this->targetDirs[3].'\\src\\UserBundle\\Resources\\config\\doctrine') => 'UserBundle\\Entity']);
$c->setGlobalBasename('mapping');

$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\OffreBundle\\Entity')]), 'OffreBundle\\Entity');
...
$a->setEntityNamespaces(['OffreBundle' => 'OffreBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity']);
