 ...
 */
class Forum extends \Reclamation1Bundle\Entity\Forum implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Reclamation1Bundle\\Entity\\Forum' . "\0" . 'idCommentaire', '' . "\0" . 'Reclamation1Bundle\\Entity\\Forum' . "\0" . 'nom', '' . "\0" . 'Reclamation1Bundle\\Entity\\Forum' . "\0" . 'commentaire'];
        }
