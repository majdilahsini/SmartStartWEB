 ...
 */
class Langues extends \OffreBundle\Entity\Langues implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OffreBundle\\Entity\\Langues' . "\0" . 'ref', '' . "\0" . 'OffreBundle\\Entity\\Langues' . "\0" . 'nom'];
        }
