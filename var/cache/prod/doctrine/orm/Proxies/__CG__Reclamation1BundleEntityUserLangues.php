 ...
 */
class UserLangues extends \Reclamation1Bundle\Entity\UserLangues implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Reclamation1Bundle\\Entity\\UserLangues' . "\0" . 'userId', '' . "\0" . 'Reclamation1Bundle\\Entity\\UserLangues' . "\0" . 'langue1Ref', '' . "\0" . 'Reclamation1Bundle\\Entity\\UserLangues' . "\0" . 'langue2Ref'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserLangues $proxy) {
