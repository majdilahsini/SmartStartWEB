 ...
 */
class Utilisateurs extends \Reclamation1Bundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Reclamation1Bundle\\Entity\\Utilisateurs' . "\0" . 'id', '' . "\0" . 'Reclamation1Bundle\\Entity\\Utilisateurs' . "\0" . 'nom', '' . "\0" . 'Reclamation1Bundle\\Entity\\Utilisateurs' . "\0" . 'prenom', '' . "\0" . 'Reclamation1Bundle\\Entity\\Utilisateurs' . "\0" . 'addresse', '' . "\0" . 'Reclamation1Bundle\\Entity\\Utilisateurs' . "\0" . 'mail', '' . "\0" . 'Reclamation1Bundle\\Entity\\Utilisateurs' . "\0" . 'tel'];
        }
