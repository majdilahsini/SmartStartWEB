 ...
 */
class User extends \Reclamation1Bundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'usernameCanonical', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'emailCanonical', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'enabled', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'lastLogin', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'confirmationToken', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'passwordRequestedAt', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'fullname', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'Reclamation1Bundle\\Entity\\User' . "\0" . 'tel'];
        }
