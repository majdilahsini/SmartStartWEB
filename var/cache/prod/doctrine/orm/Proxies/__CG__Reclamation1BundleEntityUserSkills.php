 ...
 */
class UserSkills extends \Reclamation1Bundle\Entity\UserSkills implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Reclamation1Bundle\\Entity\\UserSkills' . "\0" . 'userId', '' . "\0" . 'Reclamation1Bundle\\Entity\\UserSkills' . "\0" . 'skill1Id', '' . "\0" . 'Reclamation1Bundle\\Entity\\UserSkills' . "\0" . 'skill2Id', '' . "\0" . 'Reclamation1Bundle\\Entity\\UserSkills' . "\0" . 'skill3Id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserSkills $proxy) {
