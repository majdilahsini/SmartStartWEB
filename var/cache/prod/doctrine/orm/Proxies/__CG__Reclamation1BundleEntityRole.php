 ...
 */
class Role extends \Reclamation1Bundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Reclamation1Bundle\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'Reclamation1Bundle\\Entity\\Role' . "\0" . 'rolename', '' . "\0" . 'Reclamation1Bundle\\Entity\\Role' . "\0" . 'number'];
        }
